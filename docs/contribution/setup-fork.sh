...
# upstream   https://github.com/steveonjava/ProxmoxVE.git (fetch)
# upstream   https://github.com/steveonjava/ProxmoxVE.git (push)
```
...
print_info "Upstream: https://github.com/steveonjava/ProxmoxVE"
echo ""
