...
service:
  ...
  steveonjava/ProxmoxVE:
    latest_version:
      type: github
      url: steveonjava/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/steveonjava/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://community-scripts.org/
      web_url: https://github.com/steveonjava/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
