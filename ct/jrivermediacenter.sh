...
echo -e "${INFO}${YW} Secure native VNC can be enabled from the Dashboard on port ${BGN}5902${CL}${YW} for TigerVNC clients and uses the same Dashboard credentials while UI mode is active.${CL}"
